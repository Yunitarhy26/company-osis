	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-3 ml-auto col-sm-6">
				<div class="widget">
					<div class="logo mb-4">
						<h3>o<span>sis.</span></h3>
					</div>
					<h6><a href="tel:+23-345-67890" >Support@osis.com</a></h6>
		...
		<div class="footer-btm pt-4">
			<div class="row">
				<div class="col-lg-4 col-md-12 col-sm-12">
					<div class="copyright">
						&copy; Copyright Reserved to <span class="text-color">osis.</span> by <a href="https://themefisher.com/" target="_blank">Themefisher</a>
					</div>
				</div>
